...
@section ('contenido')
            ...
            <div class="card">
              ...
              <div class="row">
                <div class="col-md-10">
                  ...
                  <label for=""><h5>&nbsp; {{ $inscripcion->alumno->primer_nombre }} {{ $inscripcion->alumno->segundo_nombre }} {{ $inscripcion->alumno->primer_apellido }} {{ $inscripcion->alumno->segundo_apellido }}</h5></label>
                </div>
                <div class="col-md-2">
    ...
    @push ('scripts')
      ...
      $(".mora").each(function(){
        totalMora+=parseInt($(this).html()) || 0;
      });
      ...
      total = ($("#plan").html() * $("#cuota").html()) + totalMora + morapendiente;
