        ...
        <div class="row">
          <div class="col-sm-12">
            ...
            <div class="card">
              ...
              <form class="" action="{{ route('administrativo.update',$persona->id_persona) }}" method="post" enctype="multipart/form-data">
                {!!method_field('PUT')!!}
                  {!!csrf_field()!!}
                  ...
                  <div class="card-body">
                    <div class="row">
                      ...
                      <select name="tipo_persona" class="form-control select2-single" id="select-busqueda">
                        @if ($persona->tipo_persona=='admin')
                          <option disabled value="">Seleccione tipo de persona: </option>
                          <option selected value="admin">Administrador</option>
                          <option value="director">Director</option>
                          <option value="secre">Secretaria</option>
                        @elseif ($persona->tipo_persona=='director')
                          <option disabled value="">Seleccione tipo de persona: </option>
                          <option value="admin">Administrador</option>
                          <option selected value="director">Director</option>
                          <option value="secre">Secretaria</option>
                        @elseif ($persona->tipo_persona=='secre')
                          <option disabled value="">Seleccione tipo de persona: </option>
                          <option value="admin">Administrador</option>
                          <option value="director">Director</option>
                          <option selected value="secre">Secretaria</option>
                        @endif
                      </select>
                      </div>
              ...
              <div class="card-footer">
                <a href="{{ route('administrativo.index') }}"> <button type="button" class="btn btn-sm btn-success"><i class="fa fa-toggle-left"></i> Atrás</button></a>
