          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header">
                ...
                <a href="administrativo/create"> <button type="button" class="pull-right  btn btn-success btn-sm"> <span class="fa fa-plus"></button></a>
