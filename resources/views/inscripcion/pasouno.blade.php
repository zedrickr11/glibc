          ...
          <div class="col-sm-12">
            ...
            <div class="card">
              <div class="card-header">
                <strong>Registrar Padre o Encargado</strong>
                <small></small>
              </div>
              ...
              <div class="card-footer">
                ...
                <a href="{{ route('inscripcion.pasodos') }}"> <button type="button" class="pull-right  btn btn-success btn-sm"> Siguiente &nbsp;<span class="icon-control-play"></button></a>
              </div>
              </form>
            </div>
