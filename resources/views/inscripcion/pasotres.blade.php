          ...
          <div class="col-sm-12">
            <div class="card">
                ...
                <div class="row">
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <select name="id_alumno" class="form-control select2-single" id="id_alumno">
                      ...
                      @else
                        @foreach($alumnos as $alumno)
                          <option value="{{ $alumno->id }}" {{ $id_alumno == $alumno->id ? 'selected': '' }}>{{ $alumno->primer_nombre }} {{ $alumno->segundo_nombre }} {{ $alumno->primer_apellido }} {{ $alumno->segundo_apellido }}</option>
                        @endforeach
                      @endif
                    </select>
              ...
              <div class="card-footer">
                <a href="{{ route('inscripcion.pasodos') }}"> <button type="button" class="btn btn-sm btn-success"><i class="fa fa-toggle-left"></i> Atrás</button></a>
