          ...
          <div class="col-sm-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <input type="hidden" name="opcion" value="porpasos">
                </div>
              </div>
              <div class="card-footer">
                <a href="{{ route('inscripcion.pasouno') }}"> <button type="button" class="btn btn-sm btn-success"><i class="fa fa-toggle-left"></i> Atrás</button></a>
                <button type="submit" class="btn btn-sm btn-primary"><i class="fa fa-dot-circle-o"></i> Guardar</button>
                <button type="reset" class="btn btn-sm btn-danger"><i class="fa fa-ban"></i> Cancelar</button>
                <a href="{{ route('inscripcion.pasotres') }}"> <button type="button" class="pull-right  btn btn-success btn-sm"> Siguiente &nbsp;<span class="icon-control-play"></button></a>
              </div>
              </form>
            </div>
          </div>
